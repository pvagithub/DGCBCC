...
using CBCC.Utilities;

namespace CBCC.Account
{
    public class CBCCMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            string hash = UtilitiesHelper.GetMd5Hash(password.Trim());
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            string hash = UtilitiesHelper.GetMd5Hash(newPassword.Trim());
        ...
        public MembershipCreateStatus CreateUser(string userName, string password)
        {
            ...
            if (user == null)
            {
                CBCC.Models.Membership userObj = new CBCC.Models.Membership();

                userObj.Username = userName;
                userObj.Password = UtilitiesHelper.GetMd5Hash(password);

                using (var usersContext = new CBCCEntities())
                {
        ...
        public CBCC.Models.Membership GetUserByUserName(string username)
        {
            var db = new CBCCEntities();
